...
@section('body')
    {{-- Title pane --}}
    <div class="title">
        <h1 class="font-normal text-2xl ml-4 mt-2">Teachers Loading</h1>
    </div>
    <div class="outer-container flex flex-col md:flex-row items-center justify-between">
        <div class="search-box md:w-3/12 w-11/12">
            ...
            <input type="search" name="searchBar" id="search" placeholder="search subject.." class="relative left-0 top-0 bg-zinc-200 md:ml-4 mt-2 px-3 py-1.5 rounded-xl w-full md:w-72">
        </div>
        ...
        <div class="buttons flex items-center justify-evenly w-80 mt-2">
            ...
            <span class="hidden md:block">
                <button type="button" class="relative text-sm flex items-center border-[#800000] bg-[#800000] w-[150px] h-[40px] cursor-pointer group rounded-xl" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                    ...
                    <div class="modal-body">
                        <form action="" method="post" name="teachersForm" id="teachers-form">
                            ...
                            <div class="modal-button flex items-center justify-end gap-2 mt-3">
                                ...
                                <button type="button" class="bg-[#800000] p-2 w-[120px] text-white rounded-lg" data-bs-dismiss="modal">Save</button>
                            </div>
                        </form>
					</div>
                </div>
