...
@section('body')
    {{-- Title pane --}}
    <div class="title">
        <h1 class="font-normal text-2xl mt-2">Manage Classroom</h1>
    </div>
    <div class="outer-container flex flex-col md:flex-row items-center justify-between">
        <div class="search-box md:w-3/12 w-11/12">
            ...
            <input type="search" name="searchBar" id="search" placeholder="search classroom.." class="relative left-0 top-0 bg-zinc-200 mt-2 px-3 py-1.5 rounded-sm w-full md:w-72">
        </div>
